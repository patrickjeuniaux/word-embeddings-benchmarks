...
def fetch_GloVe(dim=300, corpus="wiki-6B", normalize=True, lower=False, clean_words=False):
  ...
  print("\nFetch {} embeddings, corpus: {}, dim: {}, normalize: {}, lower: {}, clean_words: {}\n---\n".
        format("GloVe", corpus, dim, normalize, lower, clean_words))
...
def fetch_HPCA(which, normalize=True, lower=False, clean_words=False):
  ...
  print("\nFetch {} embeddings, which: {}, normalize: {}, lower: {}, clean_words: {}\n---\n".
        format("HPCA", which, normalize, lower, clean_words))
...
def fetch_morphoRNNLM(which, normalize=True, lower=False, clean_words=False):
  ...
  print("\nFetch {} embeddings, normalize: {}, lower: {}, clean_words: {}\n---\n".
        format("morphoRNNLM", normalize, lower, clean_words))
...
def fetch_PDC(dim=300, normalize=True, lower=False, clean_words=False):
  ...
  print("\nFetch {} embeddings, dim: {}, normalize: {}, lower: {}, clean_words: {}\n---\n".
        format("PDC", dim, normalize, lower, clean_words))
...
def fetch_HDC(dim=300, normalize=True, lower=False, clean_words=False):
  ...
  print("\nFetch {} embeddings, dim: {}, normalize: {}, lower: {}, clean_words: {}\n---\n".
        format("HDC", dim, normalize, lower, clean_words))
...
def fetch_SG_GoogleNews(normalize=True, lower=False, clean_words=False):
  ...
  print("\nFetch {} embeddings, normalize: {}, lower: {}, clean_words: {}\n---\n".
        format("SG_GoogleNews", normalize, lower, clean_words))
...
def fetch_LexVec(which="commoncrawl-W+C", normalize=True, lower=False, clean_words=False):
  ...
  print("\nFetch {} embeddings, which: {}, normalize: {}, lower: {}, clean_words: {}\n---\n".
        format("LexVec", which, normalize, lower, clean_words))
...
def fetch_conceptnet_numberbatch(clean_words=False):
  ...
  print("\nFetch {} embeddings, clean_words: {}\n---\n".
        format("conceptnet_numberbatch", clean_words))
...
def fetch_FastText(lang="en", normalize=True, lower=False, clean_words=False):
  ...
  print("\nFetch {} embeddings, lang: {}, normalize: {}, lower: {}, clean_words: {}\n---\n".
        format("FastText", lang, normalize, lower, clean_words))
